...
function buildMainButtons() {
  return [
    new ActionRowBuilder().addComponents(
      new ButtonBuilder()
        .setCustomId('absence_create')
        .setLabel('Abwesenheit eintragen')
        .setStyle(ButtonStyle.Primary),
      new ButtonBuilder()
        .setCustomId('absence_list')
        .setLabel('Aktuelle Abwesenheiten')
        .setStyle(ButtonStyle.Secondary),
      new ButtonBuilder()
        .setCustomId('sanctions_me')
        .setLabel('Meine Sanktionen')
        .setStyle(ButtonStyle.Danger),
      new ButtonBuilder()
        .setCustomId('sanctions_overview')
        .setLabel('Sanktionsübersicht')
        .setStyle(ButtonStyle.Secondary)
    ),
    new ActionRowBuilder().addComponents(
      new ButtonBuilder()
  ...
  try {
    ...
    if (interaction.isRepliable()) {
      try {
        ...
        console.error('Fehler beim Senden der Fehlermeldung:', innerError);
      }
    }
  }
});
